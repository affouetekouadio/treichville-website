...
const MessageMaire: FrontendPage = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero harmonisé */}
      <section className="relative bg-gradient-to-br from-[#1d8595] to-teal-700 py-20 overflow-hidden">
        <div
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          >
            <div className="relative">
              <div className="aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl border-4 border-white">
                <img
                  src="/images/last-personnes/maire.jpg"
                  alt="Maire de Treichville"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-[#f8812f]/20 rounded-full blur-2xl" />
              <div className="absolute -top-6 -left-6 w-32 h-32 bg-[#1d8595]/20 rounded-full blur-2xl" />
            </div>
          ...
          >
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <p className="text-lg">
                <span className="text-5xl text-[#1d8595] font-serif float-left mr-3 mt-1">"</span>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 py-16 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#1d8595] rounded-full blur-3xl" />
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <p className="text-[#1d8595] font-semibold uppercase tracking-wider text-sm mb-3">Notre vision</p>
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-xl">
            <div className="grid sm:grid-cols-2 gap-4">
              {engagements.map((engagement, idx) => (
                ...
                >
                  <CheckCircle2 className="w-6 h-6 text-[#1d8595] flex-shrink-0 mt-0.5" />
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-br from-[#1d8595] to-teal-700 rounded-3xl p-8 lg:p-12 text-center text-white relative overflow-hidden"
        >
          <div className="absolute inset-0 opacity-10">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="px-8 py-4 bg-white text-[#1d8595] rounded-xl font-semibold hover:bg-gray-100 transition-colors shadow-xl"
              >
                Nous contacter
              </Link>
              <a
