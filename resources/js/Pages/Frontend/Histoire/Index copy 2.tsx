...
import { Calendar, MapPin, Users, Building, BookOpen, Ship, ShoppingBag, Landmark, Map, Heart, Home } from "lucide-react";
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden shadow-2xl">
                <img
                  ...
                  alt="Carte de Treichville"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-[#1d8595]/20 rounded-full blur-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
